...
class PromptManager:
    # Список обязательных промтов, без которых программа не может работать
    REQUIRED_PROMPTS = [
    ...
    def _ensure_dir(self):
        """Создаёт папку для промтов, если её нет."""
...
class MainApp(tk.Tk):
    ...
    def _stage4_summary(self, data=None, retry_count=0):
        ...
        # Загружаем промт из файла
        prompt_template = self.prompt_manager.get_prompt_content("stage4_summary")
        prompt = prompt_template.format(
