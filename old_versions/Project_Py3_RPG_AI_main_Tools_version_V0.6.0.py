...
class SettingsDialog:
    def __init__(self, parent, current_settings):
        ...
        ttk.Label(main_frame, text="Макс. записей ассоциативной памяти на объект:").grid(row=14, column=0, sticky="w", pady=5)
        ...
        self.max_assoc_entries.grid(row=14, column=1, sticky="w", pady=5)
