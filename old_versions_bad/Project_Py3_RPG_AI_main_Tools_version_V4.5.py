...
class MainApp(tk.Tk):
    ...
    def _stage1_request_descriptions(self, data=None, retry_count=0):
        ...
        self.center_panel.display_system_message(f"🔍 Этап 1/9: Определение объектов сцены (попытка {retry_count+1})...\n")
    ...
    def _stage1_validate_scene(self, data=None, retry_count=0):
        ...
        self.center_panel.display_system_message(f"🔍 Этап 2/9: Валидация сцены (попытка {retry_count+1})...\n")
